      ...
      <div class="wrapper"> <a href="hometemp.jsp" class="logo">design.maniacs</a>
        <nav>
          <ul class="menu">
            ...
            <li class="active"><a href="contactstemp.jsp">contacts</a></li>
          </ul>
        </nav>
      </div>
    </div>
        ...
        <div class="grid_7">
          ...
          <div class="wrapper">
            ...
            <div class="grid_3 omega">
              <div class="contacts"> <strong class="title">Mascara Inc.</strong> 8901 Marmora Road, <br>
                Tirur, D04 89GR.<br>
                Freephone:+91 9961995752<br>
                Telephone:+1 800 603 6035<br>
                FAX:+1 800 889 9898<br>
                E-mail: <a href="#" class="link">mascara@demolink.org</a>
                <p>9863 - 9867 Mill Road,</p>
                Cambridge, MG09 99HT.<br>
                Freephone:+1 800 559 6580<br>
                Telephone:+1 800 603 6035<br>
                FAX:+1 800 889 9898<br>
                E-mail: <a href="#" class="link">mascara@demolink.org</a> </div>
            </div>
          </div>
        </div>
        <div class="grid_4 prefix_1">
          ...
          <form id="contact-form">
            <fieldset>
              ...
              <label>
                <input type="text" value="Phone" onFocus="if(this.value=='Phone'){this.value=''}" onBlur="if(this.value==''){this.value='Phone'}">
              </label>
              <textarea id="tex">Message</textarea>
              <a href="#" class="button1" onClick="document.getElementById('contact-form').reset()">clear</a> <input type="submit" class="button1" value="Report" name="report" id="report">
            </fieldset>
              <% 
...
<footer>
  <div class="container_12">
    <div class="wrapper">
      <div class="grid_8"> Masacara &copy; 2017 | <a href="#">Privacy Policy</a> |</div>
      <div class="grid_4">
