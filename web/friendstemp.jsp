        ...
        <div class="grid_12">
          ...
          <ul class="wrapper works">
              <%
                        ...
                        {
                    %>
                    <!--<tr><td><a href="unfriend.jsp?fid=<%=rs1.getString(1)%>">Unfriend</a></td></tr>	-->
