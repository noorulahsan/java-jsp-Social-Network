    ...
    <div class="container_12">
      <div class="wrapper h-pad">
        <div class="grid_4 prefix_1">
            <form action="groupregfileup.jsp" enctype="multipart/form-data" method="post">
           <h3>Group Name</h3><input type="text" id="post" name="post" placeholder="Type here">
           <h3>Group Icon</h3><input type="file" name="photo" />
                <input type="submit" class="button1" name="press" value="Create"/>
        </form>
        </div>
      </div>
    </div>
